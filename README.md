This code was used to generate output for the CGIAR Crop Yield Prediction Challenge (https://zindi.africa/competitions/cgiar-crop-yield-prediction-challenge).
